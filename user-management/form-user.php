   ...
   <form action="./form-user.php<?= $option === "update" ? "?id=" . $data['0']['id'] : '' ?>" method="post">
      ...
      <div class="row">
         <div class="form-floating mb-3 col-6">
            <input <?= $option === "update" ? 'readonly' : '' ?> type="text" class="form-control" id="username" required
               name="username" placeholder="Tên tài khoản"
               value="<?= $option === "update" ? $data['0']['username'] : "" ?>">

            <label class="ms-2" for="username">Tên tài khoản</label>
         </div>
         <div class="form-floating mb-3 col-6">
            <input <?= $option === "update" ? '' : 'required' ?> type="password" class="form-control" id="password"
               name="password" placeholder="Mật khẩu">
            <label class="ms-2" for="password">Mật khẩu</label>
         </div>
         <div class="form-floating mb-3 col-6">
            <input type="text" class="form-control" id="fullName" required name="fullName" placeholder="Họ và tên"
               value="<?= $option === "update" ? $data['0']['fullName'] : "" ?>">
            <label class="ms-2" for="fullName">Họ và tên</label>
         </div>
         <div class="form-floating mb-3 col-6">
            <input type="text" class="form-control" id="address" required name="address" placeholder="Địa chỉ"
               value="<?= $option === "update" ? $data['0']['address'] : "" ?>">
         ...
         <div class="form-floating mb-3 col-6">
            <input type="email" class="form-control" id="email" required name="email" placeholder="Email"
               value="<?= $option === "update" ? $data['0']['email'] : "" ?>">
            <label class="ms-2" for="email">Email</label>
         </div>
         <div class="form-floating mb-3 col-6">
            <input type="date" min="1" class="form-control" id="birthDay" required name="birthDay"
               placeholder="Ngày sinh" value="<?= $option === "update" ? $data['0']['birthDay'] : "" ?>">
